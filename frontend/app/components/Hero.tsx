import { Container, Badge, Button, Group, Text, Title, Box, Image, Tooltip } from '@mantine/core';
    ...
    >
      ...
      >
        <Box
          ...
          >
            Tanjiro Kamado, joined with Inosuke Hashibira, a boy raised by boars who wears a boar's head,
            and Zenitsu Agatsuma, a scared boy who reveals his true power when he sleeps, boards the Infinity Train.
          </Text>
          <Group gap="md">
