...
import { Box, Title, ActionIcon, Tooltip, ScrollArea } from '@mantine/core';
...
export function AnimeCarousel({ title, items }: AnimeCarouselProps) {
  ...
  const scroll = (direction: 'left' | 'right') => {
    if (viewportRef.current) {
      ...
      const newScrollLeft = viewportRef.current.scrollLeft + (direction === 'right' ? scrollAmount : -scrollAmount);
